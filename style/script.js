...
const messages = [
  "🐰❤️🐻",
  "cuộc đời giông tố mong anh đừng cố ,về nhà em thương nha", 
  "Anh có đường hong , như e nè e đường đột thích anh",
  "Ông xã oiiiiii",
  "Em yêu anh ❤️",
  "Bận gì cũng nhớ ăn đầy đủ , tắm đúng giờ và iu thưn em nhoaaa😘",
  "Yêu chồng 🐻",
  "Lớp du so mơchhhh",
  "Ruby channnnn hăiiiiu😈",
  "Liuuu liuuuuu liuuu liuuuuu ",
  "Yêu ông xã nhất trên đờiiiii❤️❤️❤️",
  "🐻🐰",
  "🐻🐻🐻",
  "🐰🐰🐰"
];
